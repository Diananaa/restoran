          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal" method="POST" enctype="multipart/form-data" action="aksi_tambahMakanan.php">
                  <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Nama Makanan <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" type="text" required value="<?= $ambil['m_namamakanan'] ?>" />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Jumlah Makanan<span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" name="jmlh" type="number" required value="<?= $ambil['dm_JumlahMakanan'] ?>"/>
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Tanggal</label>
                      <div class="col-lg-10">
                        <input class="form-control" type="text" required value="<?= date('Y-m-d') ?>" readonly/>
                      </div>
                    </div>

                    <div class="form-group">
                      <div class="col-lg-offset-2 col-lg-10">
                         <input type="hidden" value="<?=$ambil['id_makanan'] ?>" name="id">
